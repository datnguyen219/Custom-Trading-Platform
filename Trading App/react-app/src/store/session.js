...
export const addBuyThreshold = (id, symbol, thresholdValue, orderQuantity) => async dispatch => {
  const response = await fetch(`/api/limit_orders/${id}/buy`, {
    method: "PUT",
    headers: {
      'Content-Type': 'application/json'
    },
...
export const addSellThreshold = (id, symbol, thresholdValue, orderQuantity) => async dispatch => {
  const response = await fetch(`/api/limit_orders/${id}/sell`, {
    method: "PUT",
    headers: {
      'Content-Type': 'application/json'
    },
