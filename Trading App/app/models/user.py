...
class User(db.Model, UserMixin):
    ...
    def to_dict(self):
        return {
            ...
            'buy_limit_orders': [buy_limit_order.to_dict() for buy_limit_order in self.buy_limit_orders],
            'sell_limit_orders': [sell_limit_order.to_dict() for sell_limit_order in self.sell_limit_orders],
