...
from .api.limit_order_routes import limit_orders_routes
from .api.notification_routes import notifications_routes
...
app.register_blueprint(limit_orders_routes,url_prefix=("/api/limit_orders"))
